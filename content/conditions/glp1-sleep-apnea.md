...
<li><strong>Pregnancy or planning pregnancy</strong> — stop GLP-1 medications at least 2 months before conception</li>
</ul>
</div>
...
3. **Have your sleep doctor prescribe Zepbound specifically** for OSA, not weight loss
4. **Include your BMI** — the FDA indication requires obesity (BMI 30+)
5. **Be prepared to appeal** — even with FDA approval, some insurers require prior authorization and may initially deny
...
<li>Your BMI and weight history</li>
</ul>
</div>
...
<h2 id="tips" style="border-left: 4px solid #0284c7; padding-left: 16px; color: #1c1917;">Tips for Sleep Apnea Patients Starting GLP-1s</h2>

<div style="background: #f5f5f4; border: 1px solid #e7e5e4; border-radius: 12px; padding: 24px; margin: 24px 0;">

1. **Keep using your CPAP.** At least until your sleep doctor says otherwise. GLP-1 benefits take months to fully kick in, and untreated sleep apnea in the meantime is dangerous.

2. **Start low, go slow.** All GLP-1 medications start at a low dose and titrate up. This minimizes nausea and GI side effects. Don't rush dose escalation.

3. **Get a follow-up sleep study.** After 6-12 months on a GLP-1, ask your sleep doctor for a repeat sleep study to reassess your AHI. This is how you know if CPAP settings need adjusting — or if you can reduce or stop CPAP use.

4. **Track your sleep quality.** Use a sleep tracker, journal, or even just note how rested you feel each morning. Many patients notice improvements before their next official sleep study.

5. **Tell your sleep doctor.** Whether you get GLP-1s through your sleep specialist, your PCP, or a telehealth platform, make sure your sleep doctor knows. They need to coordinate your care.

6. **Watch for nausea at night.** Some patients find GI side effects worse at night. If this is you, try injecting in the morning instead of evening, and avoid eating large meals before bed (which is good sleep hygiene anyway).
...
<div style="font-weight: 700; color: #059669;">Best Telehealth Platforms for GLP-1s</div>
<div style="font-size: 0.85rem; color: #059669;">Full comparison with pricing</div>
</a>

<a href="/conditions/glp1-fatty-liver/" style="display: block; background: #f5f5f4; border: 1px solid #e7e5e4; border-radius: 8px; padding: 16px; text-decoration: none;">
<div style="font-weight: 700; color: #1c1917;">GLP-1s & Fatty Liver (MASH)</div>
<div style="font-size: 0.85rem; color: #78716c;">Another FDA-approved indication guide</div>
</a>

<a href="/conditions/glp1-lupus/" style="display: block; background: #f5f5f4; border: 1px solid #e7e5e4; border-radius: 8px; padding: 16px; text-decoration: none;">
<div style="font-weight: 700; color: #1c1917;">GLP-1s & Lupus</div>
<div style="font-size: 0.85rem; color: #78716c;">Anti-inflammatory benefits for autoimmune conditions</div>
</a>
...
<div style="font-size: 0.85rem; color: #78716c;">Joint pain and mobility improvements</div>
</a>
